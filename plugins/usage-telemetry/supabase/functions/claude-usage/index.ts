...
const KINDS = new Set(['api', 'tool', 'prompt', 'jev.suggested', 'jev.decision', 'jev.skill_load', 'router.call', 'openrouter.key', 'jev.miss', 'jq.decision', 'jq.outcome', 'jev.arm', 'delegate.run'])
